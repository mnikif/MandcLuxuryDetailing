        ...
        <div style={{ ...wrap, position: "relative", zIndex: 10, paddingTop: "7rem", paddingBottom: "5rem", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", width: "100%" }}>
          ...
          <div className="hero-cta-row" style={{ width: "100%", display: "flex", alignItems: "flex-start", gap: "1.5rem", paddingLeft: "max(0px, calc(50% - 16rem))" }}>
            ...
            <div className="anim-up d4" style={{ flex: "0 0 auto", width: "22rem", display: "flex", flexDirection: "column", gap: "0.75rem", alignItems: "flex-start" }}>
              {/* Availability badge */}
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", background: "rgba(201,168,76,0.08)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "2px", padding: "0.4rem 0.875rem", alignSelf: "center" }}>
              ...
              <p style={{ color: "#7a7a7a", fontSize: "0.72rem", fontFamily: "var(--font-mono)", letterSpacing: "0.12em", textAlign: "center", alignSelf: "center", marginTop: "-0.25rem" }}>
                Packages from $99 —{" "}
                <Link href="/services" style={{ color: "#c9a84c", textDecoration: "underline", textUnderlineOffset: "3px" }}>
                  See Pricing
                </Link>
              </p>

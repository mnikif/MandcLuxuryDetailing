    ...
    <>
      ...
      >
        <nav style={{
          ...
          <Link href="/" style={{ display: "flex", flexDirection: "column", lineHeight: 1, textDecoration: "none", marginRight: "auto" }}>
            ...
            <span style={{ fontSize: "0.75rem", letterSpacing: "0.35em", textTransform: "uppercase", color: "#565656", fontFamily: "var(--font-mono)", lineHeight: 1.2, marginTop: "1px" }}>
              Luxury Detailing
            </span>
          </Link>
          ...
          <ul className="hidden md:flex" style={{ position: "absolute", left: "50%", transform: "translateX(-50%)", alignItems: "center", gap: "1.1rem", listStyle: "none", margin: 0, padding: 0 }}>
            {links.filter(l => l.label !== "Book Now").map(({ href, label }) => {
              ...
              return (
                <li key={href}>
                  <Link href={href} className="hover:text-[#f2ede4]" style={{ fontSize: "0.7rem", fontFamily: "var(--font-mono)", letterSpacing: "0.12em", textTransform: "uppercase", color: active ? "#c9a84c" : "#7a7a7a", transition: "color 0.2s", textDecoration: "none" }}>
                    {label}
                  </Link>
                </li>
              );
      ...
      >
        ...
        <nav style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 2rem" }}>
          {links.map(({ href, label }) => {
            ...
            return (
              ...
              >
                {label}
                <span style={{ fontSize: "1rem", color: "#565656", fontFamily: "var(--font-mono)", fontStyle: "normal" }}>→</span>
              </Link>
            );
          })}
        </nav>
        ...
        <div style={{ padding: "1.5rem 2rem", borderTop: "1px solid #1c1c1c", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <a href="tel:+17816325193" style={{ color: "#565656", fontSize: "0.75rem", fontFamily: "var(--font-mono)", letterSpacing: "0.15em" }}>
            (781) 632-5193
          </a>
